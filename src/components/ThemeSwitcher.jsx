...
function ThemeSwitcher() {
  ...
  return (
    <div className="flex h-8 w-14 items-center justify-around rounded-full bg-[#1F2937] dark:bg-[#111827]">
      <button
        className={`${activeCircleStyles} ${theme === "light" ? "bg-white transition-all duration-200 ease-in-out" : ""}`}
        onClick={() => toggleTheme("light")}
      >
        <svg
          width="14"
          className="rounded-full  fill-gray-800 dark:fill-gray-100"
          height="13"
          viewBox="0 0 14 13"
          fill="none"
      ...
      <button
        className={`${activeCircleStyles} ${theme === "dark" ? "bg-white transition-all duration-200 ease-in-out" : ""}`}
